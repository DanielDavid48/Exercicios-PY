...
def resumo(num=0, taxaa=10, taxar=5):
    ...
    print(f'com a {taxaa}% de aumento: \t{aumentando(num, taxaa, True)}')
    print(f'Com a {taxar}% de diminuição: \t{diminuindo(num, taxar, True)}')
    print('='*30)